...
--
-- Table structure for table `aspect_result`
--

CREATE TABLE `aspect_result` (
...
--
-- Dumping data for table `aspect_result`
--

INSERT INTO `aspect_result` (`ID`, `Uploadkey`, `Groupname`, `Precision`, `Recall`, `F1Score`) VALUES
